...
counter = 0
points = 0
q1 = str(input('What color is the sky on a clear, sunny day? (to answer, type lowercase letter. ex: a)\na) Green\nb) Blue\nc) Purple\nd) Red\nAnswer: '))
if q1 == 'b':
    print('Correct!')
    counter +=1
    points +=1                
    ...
    print('Incorrect')
q2 = str(input('Which animal says "meow" \na) Dog\nb) Cat\nc) Cow\nd) Bird\nAnswer: '))
if q2 == 'b':
    print('Correct!')
    counter +=1
    points +=1
...
if q3 == 'b':
    ...
    print('Incorrect')
q4 = str(input('What do humans need to survive? (multiple choice, only include the letters. ex: b d) \na) Water \nb) Candy \nc) Air \nd) Toys \nAnswers: '))
if q4 == 'a' and q4 == 'c':
...
bday = str(input('Enter your birth month and day. (ex: january 30'))
